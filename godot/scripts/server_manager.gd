...
#region RPC handlers from clients
...
func receive_welcome_message(message_obj:Dictionary) -> void:
    log.info("Received Welcome Message: %s" % JSON.stringify(message_obj, "\t"))
...
#region Server status and management
...
func _on_peer_connected(id: int) -> void:
    ...
    receive_welcome_message.rpc_id(id, {
